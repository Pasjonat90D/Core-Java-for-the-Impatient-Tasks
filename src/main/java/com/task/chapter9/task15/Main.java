...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        String fileString = System.getProperty("user.dir") + "\\src\\main\\java\\com\\task\\chapter9\\task15\\file";


        PointTable[] points = {
                new PointTable(1.1, 1.2),
                new PointTable(2.1, 2.2),
                new PointTable(3.1, 3.2),
                new PointTable(4.1, 4.2)};
